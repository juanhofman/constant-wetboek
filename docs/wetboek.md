# Wetboek Constantinopel

## Wetstechnische informatie

| | |
|---|---|
| Overheidsorganisatie      | Hoge Raad Constantinopel |
| Officiële naam            | Algemeen Wetboek Constantinopel |
| Citeertitel               | Wetboek Constantinopel |
...
1. Het Wetboek Constantinopel (verder aangeduid als WCONST) is leidend voor alle beschreven gevallen, waarbij als aanvulling het Nederlands Recht van toepassing is.
2. Het WCONST heeft betrekking op het vaste land, de gemeente, en de stad Constantinopel.
3. Het WCONST is nauw verweven met de Algemene Plaatselijke Verordening Constantinopel (APV). De APV dient echter als een indicerend kader voor eventuele bestraffing in-game (“in RP”) en is verder bedoeld voor het afhandelen van straffen buiten de RP om.
...
3. Minderjarigen worden binnen Constantinopel op dezelfde manier behandeld als volwassenen. Alle bepalingen, straffen en dergelijke zijn ook van toepassing op hen. Minderjarigen hebben dezelfde rechten en plichten als volwassenen. Het jeugdstrafrecht is in Constantinopel niet van toepassing.
...
3. Geldige redenen voor inbeslagname zijn:
    1. Plegen van een strafbaar feit uit het wetboek van Constantinopel waarbij het goed direct of indirect betrokken is, behalve fout parkeren en een snelheidsovertreding;
...
---------------------
*Wetboek Constantinopel is opgesteld uit naam van het management, de gemeente en de stad Constantinopel, opgetekend door Robert Hoffman, te Constantinopel.*
