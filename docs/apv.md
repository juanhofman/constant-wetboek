# Algemene Plaatselijke Verordening Constantinopel 2022

## Informatie

| | |
|---|---|
| Overheidsorganisatie      | Management Constantinopel |
| Officiële naam regeling   | Algemene Plaatselijke Verordening Constantinopel 2022 |
| Citeertitel               | Algemene Plaatselijke Verordening Constantinopel|
| Vastgesteld door          | Management|
| Onderwerp                 | Openbare orde en veiligheid|

### Opmerkingen met betrekking tot de verordening

Het Wetboek van Strafrecht, specifiek bedoeld voor Constantinopel, vervangen door deze APV ter bevordering van de algemene regels in Constantinopel.

## Algemene Bepalingen

### A1 - Reikwijdte

1. Deze Algemene Plaatselijke Verordening (verder aangeduid als APV) is bedoeld als aanvulling op het Nederlands Recht en heeft betrekking op de stad Constantinopel.
...
1. Aanvullend op de APV is er het Wetboek Constantinopel (WCONST), waarin alle wetten, artikelen en bepalingen zijn opgenomen die gelden in Constantinopel.
...
2. Dit Wetboek heeft, net als de APV, een basis in het Nederlands Recht.
   * Het Nederlands Recht is zodoende leidend, *tenzij* er een Wet of Bepaling is opgenomen in de WCONST. Dan is deze leidend.
...
5. Enkele voorbeelden van lid 1 en lid 3 zijn:
   - Niet meewerken aan een roleplay scenario of een /me-command, bijvoorbeeld opzettelijk een onjuiste porto frequentie doorgeven nadat er een roleplay actie is uitgevoerd om dit te achterhalen;
   ...
   - Head ID's misbruiken om spelers te vinden/identificeren tijdens een roleplay scenario;
   ...
   - Het spelen op een zodanige resolutie dat er redelijkerwijs vanuit kan worden gegaan dat hier voordeel uit wordt gehaald.
...
2. Bij een overtreding van de regel genoemd in lid 1 zal de persoon erop gewezen worden volgende keer gelieve “/report” te gebruiken of een ticket aan te maken in de Constantinopel Discord.
...
1. Het is voor een ambtenaar toegestaan dat zij zich bezig houden met criminele activiteiten, deze regel is niet van toepassing wanneer u politie agent bent.
